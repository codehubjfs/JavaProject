...
public class Infrastructure {
	...
	public static void infrastructuredetails(int key,String username,Scanner sc) throws SQLException	{	
		boolean infrastructureFlag=true;
		
		while(infrastructureFlag) {
