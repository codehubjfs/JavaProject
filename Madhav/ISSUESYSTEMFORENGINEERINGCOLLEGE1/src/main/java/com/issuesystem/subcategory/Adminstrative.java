...
import com.issuesystem.userdefinedxception.DateException;
...
//	 GET ADMINSTRATIVE DETAILS
	public static void adminstractivedetails(int key,String username,Scanner sc) throws SQLException	{	
		boolean adminstractiveFlag=true;
		while(adminstractiveFlag) {
